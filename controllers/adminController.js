...
module.exports = {
    ...
    viewCategory : async (req, res) =>{
        try {
            ...
            const alertStatus = req.flash('alertStatus');
            const alert = {message:alertMessage, status:alertStatus};
            res.render('admin/category/view_category', {category,       user: req.session.user, alert, title : 'Staycation | Category'});
        } catch (error) {
    ...
    viewDetailItem : async (req, res) =>{
        ...
        try {
            ...
            res.render('admin/item/detail_item/view_detail_item',{
                title: 'Staycation | Detail Item', alert, itemId, feature, activity, user: req.session.user
            })
